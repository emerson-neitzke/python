...
class pump(wx.Panel):
    def __init__(self, parent, id, posxy, caption):
        wx.Panel.__init__(self, parent, id, pos=posxy, size=(320,161), style=wx.SUNKEN_BORDER)
...
class MyForm(wx.Frame):
     def __init__(self):
        ...
        wx.Frame.__init__(self, None, wx.ID_ANY, "", size=(327,212), style = wx.MINIMIZE_BOX | wx.CLOSE_BOX)
     ...
     def thread_client(self, arg1, conn, cid, init):
        ...
        while self.threadClientConnected:
            ...
            if self.estado == 0:
               ...
               #SYNCHRONIZE(date,time) capturar do sistema
